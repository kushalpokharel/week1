// [assignment] please copy the entire modifpragma circom 2.0.3;
...
template sudoku() {
    ...
    component RangeProofpuzzle[9][9]; // for each element
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            RangeProofpuzzle[i][j].range[1] <== 9; //inclusive

            //output of above RangeProof must be 1.
            ...
            RangeProofsolution[i][j].range[1] <== 9; //inclusive
